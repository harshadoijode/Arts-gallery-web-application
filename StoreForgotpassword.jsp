...
<form  method="get" action="">
  <table width="480" border="1" align="center"  style="color:#FFFFFF;">
    <tr>
      <td align="right" width="199">enter your ID number </td>
      <td width="265"><input name="id" type="text"  required/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
rst=stmt.executeQuery("select storemobileno from stores where storeid='"+request.getParameter("id")+"' ");
if(rst.next()){
%>
...
rst=stmt.executeQuery("select password from stores where storeid='"+request.getParameter("regno")+"' and storemobileno='"+request.getParameter("answer")+"' ");
if(rst.next()){
  %>
