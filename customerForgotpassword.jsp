...
rst=stmt.executeQuery("select phone from customer where email='"+request.getParameter("id")+"' ");
if(rst.next()){
%>
...
rst=stmt.executeQuery("select password from customer where email='"+request.getParameter("regno")+"' and phone='"+request.getParameter("answer")+"' ");
if(rst.next()){
  %>
