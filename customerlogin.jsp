...
<h3 align="center" style="color:#CCCCCC">Customer Login Page</h3>
  <form id="form1" name="form1" method="post" action="">
							  <table style="background:#CCCCCC; border-radius:20px;" width="auto" border="0" align="center">
								...
								<tr>
								 ...
								 <p><a href="customerForgotpassword.jsp">Forgot password</a></p>
								 </td>
								</tr>
							  </table>
...
rst=stmt.executeQuery("select * from customer where email='"+s1+"' and password='"+s2+"'");
...
window.open("customerhomepage.jsp","_self");
</script>
<%
}else{
%>
