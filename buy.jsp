...
rst=stmt.executeQuery("select productname,productprice,quantity,productid,storephone  from product  where productname='"+pname+"' ");
  ...
  <form name="form1" id="form1" action="" method="get">
   ...
   <input name="sphone" type="hidden" value="<%= rst.getString(5) %>" />
...
out.println(e);
 ...
 // out.print("product  amount"+productAmt);
  ...
  <input type="text" name="storephone"  value="<%=request.getParameter("sphone")%>"/>
