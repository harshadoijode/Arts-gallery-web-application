...
<h3 align="center" style="color:#CCCCCC">Artist Login Page</h3>
  <form id="form1" name="form1" method="post" action="">
							  <table style="background:#CCCCCC; border-radius:20px;" width="auto" border="0" align="center">
								<tr>
								  <td width="177"><div align="right" class="style2">Email</div></td>
								  <td width="338"><input name="username" type="email" /></td>
								</tr>
								<tr>
								...
								<tr>
								  ...
								  <td><p>
								    ...
								    <p><a href="addartist.jsp">Register New Artist</a></p>
								     <p><a href="artistForgotpassword.jsp">Forgot password</a></p></td>
								</tr>
							  </table>
...
rst=stmt.executeQuery("select * from artist where email='"+s1+"' and password='"+s2+"'");
if(rst.next()){
%>
<script>

alert("login Successfull");
window.open("artisttabs.html","_self");
</script>
<%
}else{
%>
